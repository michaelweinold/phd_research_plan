...
\makesavenoteenv{tabular} % for footnotes in tabular environment
        ...
        A detailed description of work packages is provided in Table \ref{tab:work_packages}. The associated timeline is rendered in a Gantt chart in Figure \ref{fig:gantt}. Note that deliverables associated with the WISER project are not listed. For a full list of WISER deliverables, compare the \textit{Innosuisse Flagship Initiative Proposal: Web of Interoperable Digital Services for Knowledge on Decarbonisation Pathways (WISER)}.
            ...
            \begin{figure}[h!]
                ...
                % title 2 (quarters)
                    ...
                    \gantttitle{Q2}{3}\\
                % work packages
                \ganttgroup[inline=false]{WP1}{1}{9} \\
                    \ganttbar[inline = true]{WP1.1}{1}{6} \\
                    \ganttbar[inline = true]{WP1.2}{6}{9} \\
                \ganttgroup[inline=false]{WP2}{9}{26} \\
                    \ganttbar[inline = true]{WP2.1}{9}{13} \\
                    \ganttbar[inline = true]{WP2.2}{13}{24} \\
                    \ganttbar[inline = true]{WP2.3}{17}{26} \\
                \ganttgroup[inline=false]{WP3}{9}{26} \\
                    \ganttbar[inline = true]{WP2.1}{9}{13} \\
                    \ganttbar[inline = true]{WP2.2}{13}{24} \\
                    \ganttbar[inline = true]{WP2.3}{17}{26} \\
                \ganttgroup[inline=false]{WP4}{9}{26} \\
                    \ganttbar[inline = true]{WP2.1}{9}{13} \\
                    \ganttbar[inline = true]{WP2.2}{13}{24} \\
                % annotations
                %    \ganttvrule[
