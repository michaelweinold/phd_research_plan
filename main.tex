...
\section{Introduction}
    ...
    Life-cycle assessment (LCA) is defined as \textit{"a tool to assess the potential environmental impacts and resources used throughout a product’s life cycle, i.e. from raw material acquisition, via production and use stages, to waste management"} by ISO 14044\cite{noauthor_iso_2006}. Originally developed in the 1960s \cite{hauschild_life_2018}, it has 
    
    Today, life-cycle assessment provides decision support for industry leaders and policy makers alike \cite{tillman_significance_2000}\cite{dong_environmental_2018}. In addition, governments have made product classifications mandatory (EXAMPLES HERE). 
