...
\section{Current State of Research}
    ...
    \subsection{Hybrid Life-Cycle Assessment}
        ...
        The first significant mention of hybrid LCA in review by Lenzen in 2000 \cite{lenzen_errors_2000}
        
        In the only comprehensive review identified, Crawford et al. \cite{crawford_hybrid_2018} detail the concerning lack of even a unified nomenclature to designate different mathematical approaches to hybridization. In an attempt to provide such a standard, they collected 
