...
Life-cycle inventory hybridization (augmentation of foreground processes from process-based life-cycle assessment database with additional information from input-output-based database) to increase accuracy of life-cycle assessment.
...
\section{Time Schedule}
    ...
    The proposed schedule associated with this research plan can be viewed as an interactive \textit{Markwhen}\footnote{\url{https://github.com/kochrt/markwhen}} timeline at \url{https://phd.weinold.ch/timeline}. The underlying markwhen file is under version control at \texttt{michaelweinold/phd\_research\_plan/timeline/phd\_research\_plan\_timeline.mw} as part of the repository containing this document.
