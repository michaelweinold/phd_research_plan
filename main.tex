...
\section{Current State of Research}
    ...
    \subsection{Hybrid Life-Cycle Assessment}
        ...
        The limitations inherent to both analysis based on process inventories and analysis based on environmentally extended input-output tables in 1978 lead to the the first development of a hybrid analysis by Bullard et al. \cite{bullard_net_1978}. 
        
        In the only comprehensive review identified, Crawford et al. \cite{crawford_hybrid_2018} detail the complete lack of even a unified nomenclature to designate different mathematical approaches to hybridization. In an attempt to provide such a standard, XXX compare figure XY: 
    ...
    \hline
        PXC & ~ & I & ~ & MA & ~ & T & ~ \\ \hline
        Input-output-based & 8 & - & 2 & - & 13 & - & 20 \\ \hline
        Path Exchange & 2 & Economic balance & 1 & Input-output-based & 11 & Additive & 3 \\ \hline
        - & 1 & Integrated & 11 & Integrated; Input-output-based & 1 & Additive EIO LCA & 1 \\ \hline
        ~ & ~ & Integrated; Input-output-based & 1 & Tiered & 1 & Consumption-weighted LCA & 1 \\ \hline
        ~ & ~ & Product equilibrium & 1 & ~ & ~ & Economic balance & 1 \\ \hline
        ~ & ~ & Tiered; Integrated; & 1 & ~ & ~ & Economic input-output-based & 2 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Hybrid input-output & 3 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Input-output-based & 1 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & MC3 & 1 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Process-based & 3 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Stochastic & 1 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Tiered & 11 \\ \hline
        ~ & ~ & ~ & ~ & ~ & ~ & Tiered; Integrated; & 1 \\ \hline
    \end{tabular}
\end{table}
        
        In an attempt to address the issues inherent in both process analysis and EEIOA, researchers have proposed the combination of process and input-output data as early as the 1970s () into a method known as hybrid analysis.
        
        Hybrid life-cycle assessment refers to the combination of two different approaches to building inventory data. 
        
        First ideas in the 80s. The first significant mention of hybrid LCA in review by Lenzen in 2000 \cite{lenzen_errors_2000}. Since then, a number of case-studies using  has been published, 
        ...
        The only review of hybrid life-cycle assessment methods identified is provided by Crawford et al. in 2018 . \cite{}
